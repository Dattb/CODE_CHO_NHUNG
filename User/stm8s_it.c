...
/**
  ...
  */
//****************************************************************************************************************************************//
//#define BUTTON_Port     (GPIOD)                // Button conected to PA2
//#define BUTTON_Pin      (GPIO_PIN_6)
//BitStatus Button_State_Old, check;
//unsigned char  Flash_Write=0;
extern unsigned char mode_effect;  //  Cac hieu ung cua LED RGB
  ...
  */
   Time_On++;
      ...
      { 
        Time_On=0;
        UpdateMode1();
          TIM2_ITConfig(TIM2_IT_UPDATE, DISABLE); // bat ngat timer 2
      }
